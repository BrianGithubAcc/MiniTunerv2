...
optuner = r"""Time of exp1 (average over 3 runs): 25.25 s
Time of exp1m (average over 3 runs): 9.14667 s
Time of log1p (average over 3 runs): 9.80333 s
Time of exp1x_log (average over 3 runs): 149.137 s
Time of logexp (average over 3 runs): 17.84 s
Time of nmse_example_3_4 (average over 3 runs): 119.827 s
Time of nmse_example_3_7 (average over 3 runs): 10.57 s
Time of nmse_example_3_8 (average over 3 runs): 118.417 s
Time of nmse_example_3_10 (average over 3 runs): 47.18 s
Time of nmse_problem_3_3_6 (average over 3 runs): 50.6667 s
Time of nmse_problem_3_3_7 (average over 3 runs): 244.777 s
Time of nmse_section_3_11 (average over 3 runs): 38.8667 s"""
...
ax.bar(x - width/2, mini_vals, width, label='minitune', color='#1f77b4', zorder=3)
ax.bar(x + width/2, opt_vals, width, label='optuner', color='#ff7f0e', zorder=3)
...
ax.set_title("minitune vs optuner - Runtime", fontsize=14, fontweight='bold', pad=15)
...
output_path = os.path.join(output_dir, "comparison_runtime.pdf")
